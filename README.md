...
1. Your code (via Gradescope);
2. The renderings (`.png` files) from the test views used for computing evaluation metrics;
3. The values of LPIPS, PSNR, SSIM from quantitative evaluation;
4. The checkpoint file (`.pth` file) is used to produce the above metrics.
